  ...
  return (
    ...
    >
      <section className="text-center mb-16">
        ...
        >
          <p>
            A highly motivated software engineer passionate about SAP UI5, SAP BTP, Cloud Foundry,
            and frontend development. Currently working on impactful projects at SAP while pursuing
            my M.Tech in Software Engineering.
          </p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          <div className={`p-6 rounded-lg ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
            ...
            <p className="text-gray-400">Scholar@SAP</p>
          </div>
          <div className={`p-6 rounded-lg ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
            <h3 className="text-xl font-semibold mb-2">Education</h3>
            <p className="text-gray-400">BITS Pilani</p>
          </div>
          <div className={`p-6 rounded-lg ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
